...
class HB_Extra_Post_Type
{
	...
	*/
	...
	{
		$labels = array(
			'name'                => __( 'Extra Room', 'tp-hb-extra' ),
			'singular_name'       => __( 'Extra Room', 'tp-hb-extra' ),
			'add_new'             => _x( 'Add New Extra Room', 'tp-hb-extra', 'tp-hb-extra' ),
			'add_new_item'        => __( 'Add New Extra Room', 'tp-hb-extra' ),
			'edit_item'           => __( 'Edit Extra Room', 'tp-hb-extra' ),
			'new_item'            => __( 'New Extra Room', 'tp-hb-extra' ),
			'view_item'           => __( 'View Extra Room', 'tp-hb-extra' ),
			'search_items'        => __( 'Search Extra Room', 'tp-hb-extra' ),
			'not_found'           => __( 'No Extra Room found', 'tp-hb-extra' ),
			'not_found_in_trash'  => __( 'No Extra Room found in Trash', 'tp-hb-extra' ),
			'parent_item_colon'   => __( 'Parent Singular Extra Room:', 'tp-hb-extra' ),
			'menu_name'           => __( 'Extra Room', 'tp-hb-extra' ),
		);

		$args = array(
			'labels'              => $labels,
			'hierarchical'        => false,
			'description'         => __( 'Extra room system booking', 'tp-hb-extra' ),
			'taxonomies'          => array(),
			'public'              => false,
			'show_ui'             => false,
			'show_in_menu'        => false,
