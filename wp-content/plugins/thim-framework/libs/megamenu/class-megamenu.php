	...
	class tp_backend_walker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			if ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
				...
				$title = sprintf( __( '%s (Pending)', 'thim-framework' ), $item->title );
			}
			...
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
                    ...
                    <span class="item-controls">
                        ...
                        <span class="item-type item-type-tp"><?php esc_attr_e( 'Column', 'thim-framework' ); ?></span>
                        <span class="item-type item-type-megafied"><?php esc_attr_e( '(Mega Menu)', 'thim-framework' ); ?></span>
                        <span class="item-order">
							...
							?>" class="item-move-up"><abbr title="<?php esc_attr_e( 'Move up', 'thim-framework' ); ?>">&#8593;</abbr></a>
                            |
                            <a href="<?php
							echo wp_nonce_url(
								add_query_arg(
							...
							?>" class="item-move-down"><abbr title="<?php esc_attr_e( 'Move down', 'thim-framework' ); ?>">&#8595;</abbr></a>
                        </span>
                        <a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" title="<?php esc_attr_e( 'Edit Menu Item', 'thim-framework' ); ?>" href="<?php
						...
						?>"><?php esc_attr_e( 'Edit Menu Item', 'thim-framework' ); ?></a>
                    </span>
				</dt>
			</dl>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
				<?php if ( 'custom' == $item->type ) : ?>
					<p class="field-url description description-wide">
						<label for="edit-menu-item-url-<?php echo esc_attr( $item_id ); ?>">
							<?php esc_attr_e( 'URL', 'thim-framework' ); ?><br />
				...
				<p class="description description-thin description-label tp_label_desc_on_active">
					<label for="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>">
						<span class='tp_default_label'><?php esc_attr_e( 'Navigation Label', 'thim-framework' ); ?></span>
						<!-- <span class='tp_mega_label'><?php _e( 'Mega Menu Column Title <span class="tp_supersmall">(if you dont want to display a title just enter a single dash: "-" )</span>', 'thim-framework' ); ?></span> -->
						<br />
				...
				<p class="description description-thin description-title">
					<label for="edit-menu-item-attr-title-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_attr_e( 'Title Attribute', 'thim-framework' ); ?><br />
				...
				<p class="field-link-target description description-thin">
					<label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_attr_e( 'link Target', 'thim-framework' ); ?><br />
						<select id="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>" class="widefat edit-menu-item-target" name="menu-item-target[<?php echo esc_attr( $item_id ); ?>]">
							<option value="" <?php selected( $item->target, '' ); ?>><?php esc_attr_e( 'Same window or tab', 'thim-framework' ); ?></option>
							<option value="_blank" <?php selected( $item->target, '_blank' ); ?>><?php esc_attr_e( 'New window or tab', 'thim-framework' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_attr_e( 'CSS Classes (optional)', 'thim-framework' ); ?><br />
				...
				<p class="field-xfn description description-thin">
					<label for="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_attr_e( 'link Relationship (XFN)', 'thim-framework' ); ?><br />
				...
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_attr_e( 'Description', 'thim-framework' ); ?><br />
				...
				<div class='tp_mega_menu_options'>
					...
					<p class="description description-wide tp_checkbox tp_mega_menu tp_mega_menu_d1">
						<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
							<?php esc_attr_e( 'Menu Icon', 'thim-framework' ) ?><br />
							...
							?>title="<?php esc_attr_e( 'Click to browse icon', 'thim-framework' ) ?>" <?php
								   ?>class="thickbox button-secondary submit-add-to-menu" <?php
								   ?>type="button" value="<?php esc_attr_e( 'Browse Icon', 'thim-framework' ) ?>"
					...
					<p class="description description-wide">
						<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
							<input type="checkbox" value="active" id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>" <?php echo esc_html( $value ); ?> /><?php esc_attr_e( 'Hide text of This Item', 'thim-framework' ); ?>
						</label>
					</p>
					...
					if ( !$depth ) {
						...
						<p class="description description-wide description_width_100">
							<?php esc_attr_e( 'Submenu Type', 'thim-framework' ); ?><br />
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>" onchange="onChangeSubmenuType(this);">
									<option value="standard" <?php echo ( $value == 'standard' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Standard Dropdown', 'thim-framework' ); ?></option>
									<option value="multicolumn" <?php echo ( $value == 'multicolumn' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Multicolumn Dropdown', 'thim-framework' ); ?></option>
									<option value="widget_area" <?php echo ( $value == 'widget_area' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Widget area', 'thim-framework' ); ?></option>
								</select>
							</label>
						</p>
						...
						<p class="description description-wide description_width_100 el_widget_area"<?php echo ent2ncr( $style ); ?>>
							<?php esc_attr_e( 'Widget Area', 'thim-framework' ); ?><br />
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>">
									<option value="" <?php echo ( $value == '' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Select Widget Area', 'thim-framework' ); ?></option>
									<?php
						...
						<p class="description description-wide description_width_100 el_multicolumn"<?php echo ent2ncr( $style ); ?>>
							<?php esc_attr_e( 'Submenu Columns (Not For Standard Drops)', 'thim-framework' ); ?><br />
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>">
									<?php
									for ( $i = 1; $i <= 5; $i ++ ) {
						...
						?>
						<p class="description description-wide description_width_100">
							<?php esc_attr_e( 'Side of Dropdown Elements', 'thim-framework' ); ?><br />
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>">
									<option value="drop_to_right" <?php echo ( $value == 'drop_to_right' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Drop To Right Side', 'thim-framework' ); ?></option>
									<option value="drop_to_left" <?php echo ( $value == 'drop_to_left' ) ? ' selected="selected" ' : ''; ?>><?php esc_attr_e( 'Drop To Left Side', 'thim-framework' ); ?></option>
								</select>
							</label>
						</p>
						...
						<p class="description description-wide el_fullwidth"<?php echo ent2ncr( $style ); ?>>
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<input type="checkbox" value="active" id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo ent2ncr( $key . "[" . $item_id . "]" ); ?>" <?php echo esc_html( $value ); ?> /><?php esc_attr_e( 'Enable Full Width Dropdown ()', 'thim-framework' ); ?>
							</label>
						</p>
						...
						<p class="description description-wide tp_checkbox tp_mega_menu tp_mega_menu_d2"<?php echo ent2ncr( $style ); ?>>
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<span class='tp_long_desc'><?php esc_attr_e( 'DropDown Background Color', 'thim-framework' ); ?></span><br />
						...
						<p class="description description-wide tp_checkbox tp_mega_menu tp_mega_menu_d2"<?php echo ent2ncr( $style ); ?>>
							<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
								<span class='tp_long_desc'><?php esc_attr_e( 'DropDown Background Image', 'thim-framework' ); ?></span><br />
								...
								<button id="browse-edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>"
										...
										onclick="open_media_browser('edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>'); return false;"><?php esc_attr_e( 'Browse Image', 'thim-framework' ); ?></button>
							</label>
						</p>
				...
				<div class="menu-item-actions description-wide submitbox">
					<?php if ( 'custom' != $item->type ) : ?>
						<p class="link-to-original">
							<?php printf( __( 'Original: %s', 'thim-framework' ), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
					<?php endif; ?>
					...
					?>"><?php esc_attr_e( 'Remove', 'thim-framework' ); ?></a> <span class="meta-sep"> | </span>
