...
<head>
	...
	<style>
		p {
			...
			margin-right: 20px;
			/*			font-family: */
		<?php //echo $_GET['font-family']?> /*;*/
			/*			color: */
		<?php //echo $_GET['color'] ?> /*;*/
			/*			font-size: */
		<?php //echo $_GET['font-size'] ?> /*;*/
			/*			font-weight: */
		<?php //echo $_GET['font-weight'] ?> /*;*/
			/*			font-style: */
		<?php //echo $_GET['font-style'] ?> /*;*/
			/*			line-height: */
		<?php //echo $_GET['line-height'] ?> /*;*/
			/*			letter-spacing: */
		<?php //echo $_GET['letter-spacing'] ?> /*;*/
			/*			text-transform: */
		<?php //echo $_GET['text-transform'] ?> /*;*/
			/*			font-variant: */
		<?php //echo $_GET['font-variant'] ?> /*;*/
			/*			text-shadow: */
		<?php //echo $textShadow ?> /*;*/
		}
...
<body class='<?php echo( $_GET['dark'] ? $_GET['dark'] : '' ); ?>'>
<?php
if ( empty( $_GET['text'] ) ):
	?>
