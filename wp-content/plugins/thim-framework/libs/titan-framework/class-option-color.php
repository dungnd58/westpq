...
class TitanFrameworkOptionColor extends TitanFrameworkOption {
	...
	public function display() {
		...
		?>
		<input class="tf-colorpicker" type="text" name="<?php echo esc_attr($this->getID()) ?>" id="<?php echo esc_attr($this->getID()) ?>" value="<?php echo ent2ncr($this->getValue()) ?>"  data-default-color="<?php echo ent2ncr($this->getValue()) ?>"/>
		<?php
