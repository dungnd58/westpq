...
class TitanFrameworkAdminPanel {
	...
	private $defaultSettings = array(
		...
		'icon' => 'dashicons-download', // Menu icon for top level menus only http://melchoyce.github.io/dashicons/
	...
	public function createAdminPage() {
		...
		if ( ! empty( $_GET['message'] ) ) {
			if ( $_GET['message'] == 'saved' ) {
				echo TitanFrameworkAdminNotification::formNotification( __( 'Settings saved.', 'thim-framework' ), esc_html( $_GET['message'] ) );
			} else if ( $_GET['message'] == 'reset' ) {
				echo TitanFrameworkAdminNotification::formNotification( __( 'Settings reset to default.', 'thim-framework' ), esc_html( $_GET['message'] ) );
			}
		}
