...
class TitanFrameworkOptionEnable extends TitanFrameworkOption {
	...
	public function display() {
		...
		if ( empty( $this->settings['enabled'] ) ) {
			$this->settings['enabled'] = __( 'Enabled', 'thim-framework' );
		}
		if ( empty( $this->settings['disabled'] ) ) {
			$this->settings['disabled'] = __( 'Disabled', 'thim-framework' );
		}
	...
	class TitanFrameworkOptionEnableControl extends WP_Customize_Control {
		...
		public function render_content() {
			...
			if ( empty( $this->options['enabled'] ) ) {
				$this->options['enabled'] = __( 'Enabled', 'thim-framework' );
			}
			if ( empty( $this->options['disabled'] ) ) {
				$this->options['disabled'] = __( 'Disabled', 'thim-framework' );
			}
			?>
			<div class='tf-enable'>
