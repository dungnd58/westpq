...
class TitanFrameworkOptionCheckbox extends TitanFrameworkOption {
	...
	public function display() {
		...
		<input name="<?php echo esc_attr($this->getID()) ?>" type="checkbox" id="<?php echo esc_attr($this->getID()) ?>" value="1" <?php checked( $this->getValue(), 1 ) ?><?php echo ''.$attributes; ?>>
		<?php echo ent2ncr($this->getDesc( true )) ?>
		</label>
		<?php
