...
$post_format_image->createOption( array(
	'name' => __( 'Select or Upload Image', 'thim-framework' ),
	'id'   => 'image',
	'type' => 'upload',
) );
...
$post_format_video->createOption( array(
	'name' => __( 'Video URL or Embeded Code', 'thim-framework' ),
	'id'   => 'video',
	'type' => 'textarea',
) );
...
$post_format_quote->createOption( array(
	'name' => __( 'Quote', 'thim-framework' ),
	'id'   => 'quote',
	'type' => 'textarea',
) );

$post_format_quote->createOption( array(
	'name' => __( 'Author', 'thim-framework' ),
	'id'   => 'author',
	'type' => 'text',
) );

$post_format_quote->createOption( array(
	'name' => __( 'Author Url', 'thim-framework' ),
	'id'   => 'author_url',
	'type' => 'text',
) );
...
$post_format_link->createOption( array(
	'name' => __( 'URL', 'thim-framework' ),
	'id'   => 'url',
	'type' => 'text',
) );
$post_format_link->createOption( array(
	'name' => __( 'Text', 'thim-framework' ),
	'id'   => 'text',
	'type' => 'text',
) );
...
$post_format_audio->createOption( array(
	'name' => __( 'Audio URL or Embeded Code', 'thim-framework' ),
	'id'   => 'audio',
	'type' => 'textarea',
) );